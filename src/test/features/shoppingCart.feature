Feature: Shopping cart page
  ...
  Description Verification of whether the dialog is displayed after clicking the "Add to cart" button
  ...
  Description Verification of whether the "Place Order" form is displayed after clicking the "Place Order" button 
